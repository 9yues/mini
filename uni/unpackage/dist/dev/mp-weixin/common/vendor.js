...
IndexModel = /*#__PURE__*/function () {function IndexModel() {_classCallCheck(this, IndexModel);}_createClass(IndexModel, [{ key: "_submitForm",
    ...
    params) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        uni.request({
          url: "".concat(_index.default.url, "/Cn/Api/save_form"),
          method: 'POST',
          header: {
    ...
    /** 授权信息提交
       * @param {any} params
       */ }, { key: "_submitUserInfo", value: function _submitUserInfo(
    params) {

      return new Promise(function (resolve, reject) {

        uni.request({
          url: "".concat(_index.default.url, "/Cn/Api/save_user"),
          method: 'POST',
          header: {
            'content-type': 'application/x-www-form-urlencoded' },
    ...
    /** 获取数据
       * @param {any} params
       */ }, { key: "_getData", value: function _getData(
    params) {

      return new Promise(function (resolve, reject) {

        uni.request({
          url: "".concat(_index.default.url, "/api/v1/topics"),
          method: 'GET',
          data: params,
          success: function success(res) {
            // 这里处理一些数据
    ...
    } }]);return IndexModel;}();var _default =



new IndexModel();exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  url: 'https://xcx.mogulinker.com' };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.checkMobile = checkMobile; // 验证手机号
